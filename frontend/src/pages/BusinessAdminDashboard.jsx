      ...
      <main style={{ maxWidth: '1200px', margin: '0 auto', padding: '32px 20px' }}>
        ...
        {(activeTab === 'availability' || activeTab === 'slots') && (
          <AvailabilityManager
            ...
            setError={setError}
            handleOpenCreateAvailability={handleOpenCreateAvailability}
            handleOpenEditAvailability={handleOpenEditAvailability}
            handleDeleteAvailability={handleDeleteAvailability}
            handleOpenCreateBlockedDate={handleOpenCreateBlockedDate}
            handleOpenEditBlockedDate={handleOpenEditBlockedDate}
